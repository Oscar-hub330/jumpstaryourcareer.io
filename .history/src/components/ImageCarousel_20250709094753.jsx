...
const slides = [
  {
    ...
    image: "/assets/branding1.jpg", // ✅ path from /public
  },
  {
        ...
        {slides.map((slide, index) => (
          <div key={index} className="relative h-[80vh] md:h-[90vh]">
            <img
              ...
              loading="lazy"
            />
            <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent flex items-center">
