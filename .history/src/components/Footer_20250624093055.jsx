...
const Footer = () => {
  return (
    <footer
      className="bg-[#fea434] text-white w-full fixed bottom-0 left-0 py-6"
      style={{ zIndex: 50 }}
    >
      <div className="max-w-screen-xl mx-auto px-4 flex flex-col md:flex-row justify-between items-start text-center md:text-left space-y-6 md:space-y-0">
