...
const Footer = () => {
  return (
    <footer className="bg-white border-t-4 border-[#fea434] text-black w-full py-1 mt-auto">
      <div className="max-w-screen-xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-1">
        
        {/* Left Section */}
        <Box className="flex flex-col items-center md:items-start space-y-8">
