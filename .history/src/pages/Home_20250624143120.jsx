...
const Home = () => {
  ...
  return (
    <div className="relative text-black flex flex-col min-h-screen">
      ...
      <div
        className="absolute top-0 left-0 right-0 h-[2400px] z-0 filter blur-sm scale-105"
        style={{
      ...
      <div className="relative z-10 flex-grow flex flex-col">
        {/* HERO SECTION */}
        <section className="min-h-[70vh] flex items-center justify-center px-4 pb-8">
      ...
      <div className="relative z-10 flex justify-center py-8 bg-transparent">
        <div className="w-4/5 bg-white/90 backdrop-blur-md rounded-xl p-1 shadow-lg">
          <Footer />
        </div>
      </div>
    </div>
