...
const projects = [
  ...
  },
  {
    ...
    description: "The Equipment Support Programme provides essential tools and resources to empower rural entrepreneurs and small businesses.Beneficiaries receive machinery, technology, and start-up equipment to enhance productivity and service delivery.This initiative bridges the resource gap, accelerating business growth and economic participation in underserved communities.",
    images: [Equip1, Equip2],
  },
  {
    title: "Sewing Learnership",
    description: "The Sewing Learnership empowered local women and youth with skills in garment design, tailoring, and textile production.Through accredited training and hands-on mentorship, participants created market-ready clothing and accessories.The programme fostered entrepreneurship, job readiness, and sustainable income generation within the community.",
    images: [Sewing1,Sewing2],
  },
];
