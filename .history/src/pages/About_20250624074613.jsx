...
const About = () => {
  ...
  <Container maxWidth="md">
    ...
    <Typography
      variant="body1"
      className="text-gray-700 text-lg leading-relaxed mb-6 px-2 md:px-6"
    >
      Join our mission and help empower the next generation.
    </Typography>

    <a href="/contact">
      <button className="px-6 py-3 rounded-full bg-[#fea434] text-white font-semibold hover:bg-[#e69420] transition duration-300 shadow-md">
        Contact Us
      </button>
    </a>
  </Container>
