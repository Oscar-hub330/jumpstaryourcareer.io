...
const departments = [
  ...
  },
  {
    title: "Finance",
    members: [
      { name: "Lesedi", surname: "Ndlovu", position: "Finance", image: lesediImg },
    ],
  },
  {
    title: "Marketing",
    members: [
      ...
      { name: "Bongile", surname: "Gama", position: "Marketing Coordinator", image: BongiweImg },
    ],
  },
  {
    title: "ICT Team",
    members: [
      ...
      { name: "Nokuthula", surname: "Msimango", position: "Technolgy Specialist", image: NokuthulamImg },
...
const cardStyle = {
  ...
  height: 320,            // FIXED height for consistent alignment
  display: "flex",
      ...
      <Container maxWidth="lg">
        ...
        <Box textAlign="center" mb={7}>
          ...
          <Typography variant="body1" color="#444" maxWidth="700px" mx="auto">
            Passionate individuals leading operations, innovation, and creating sustainable livehoods.
          </Typography>
        </Box>
      ...
      <Grid item xs={12} sm={6} md={4} key={idx} sx={{ display: 'flex', justifyContent: 'center' }}>
        ...
        <Box mb={6}>
          <Grid container spacing={2} justifyContent="space-between" alignItems="stretch">
            {departments.slice(0).map((dept, deptIdx) => (
