...
const services = [
  {
    ...
    icon: <Code sx={{ fontSize: 48, color: "linear-gradient(135deg, #fea434, #ff7e00)", WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }} />,
    description:
  ...
  },
  {
    ...
    icon: <School sx={{ fontSize: 48, color: "linear-gradient(135deg, #fea434, #ff7e00)", WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }} />,
    description:
      "Bridging the gap between education and employment through practical training, internships, and industry exposure.",
  },
  {
    title: "Entrepreneurship Development",
    icon: <People sx={{ fontSize: 48, color: "linear-gradient(135deg, #fea434, #ff7e00)", WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }} />,
    description:
  ...
  },
  {
    ...
    icon: <EmojiNature sx={{ fontSize: 48, color: "linear-gradient(135deg, #fea434, #ff7e00)", WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }} />,
    description:
  ...
  },
  {
    ...
    icon: <Construction sx={{ fontSize: 48, color: "linear-gradient(135deg, #fea434, #ff7e00)", WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }} />,
    description:
  ...
  },
  {
    ...
    icon: <Checkroom sx={{ fontSize: 48, color: "linear-gradient(135deg, #fea434, #ff7e00)", WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }} />,
    description:
