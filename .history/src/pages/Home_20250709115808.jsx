...
const Home = () => {
  ...
  const focusAreas = [
    ...
    },
    {
      ...
      description: "Equipping rural youth with problem-solving skills, entrepreneurial frameworks, and practical business toolkits to drive sustainable economic growth.",
    },
    {
