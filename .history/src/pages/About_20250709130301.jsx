...
// Your sponsor logos imports (adjust extensions & paths if needed)
import BankseatLogo from "../assets/sponsors/bankseat_logo.png"; // change extension if needed
import DeptSocialDevLogo from "../assets/sponsors/Department_of_Social_Development_(South_Africa)_logo.svg";
import VodacomLogo from "../assets/sponsors/Vodacom-Logo.png"; // corrected from .wine to .png, adjust if different
...
const About = () => {
  ...
  const sponsors = [
    { name: "Bankseat", logo: BankseatLogo },
    { name: "Department of Social Development (SA)", logo: DeptSocialDevLogo },
