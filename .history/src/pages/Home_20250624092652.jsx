    ...
    <div className="relative text-black flex flex-col min-h-screen">
      ...
      <div className="relative z-10 flex-grow">
        ...
        <section className="py-20 px-4">
          <div className="max-w-screen-xl mx-auto bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl px-8 py-14">
      ...
      <div className="relative z-10 flex justify-center py-8 bg-transparent">
        <div className="w-4/5 bg-white/90 backdrop-blur-md rounded-xl p-6 shadow-lg text-center">
          <img
            src={JumpstartLogo}
            alt="Jumpstart Footer Logo"
