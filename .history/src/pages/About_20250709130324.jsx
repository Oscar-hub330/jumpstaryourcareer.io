...
import BankseatLogo from "../assets/sponsors/bankseat_logo.svg"; // change extension if needed
import DeptSocialDevLogo from "../assets/sponsors/Department_of_Social_Development_(South_Africa)_logo.svg";
import VodacomLogo from "../assets/sponsors/Vodacom-Logo.svg"; // corrected from .wine to .png, adjust if different
