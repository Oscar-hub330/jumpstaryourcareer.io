...
const Home = () => {
  ...
  return (
    <div className="relative text-black flex flex-col min-h-screen w-full overflow-hidden bg-white">
      {/* 🔳 Navigation */}
      <AppBar position="static" sx={{ backgroundColor: "#fea434" }}>
        <Toolbar className="justify-between">
          <img src={JumpstartLogo} alt="Logo" className="h-10 w-10" />
          <Box className="hidden md:flex gap-4">
            {menuItems.map((item, idx) => (
              <Button key={idx} color="inherit" onClick={() => navigate(item.path)}>
                {item.label}
              </Button>
            ))}
          </Box>
      ...
      <main className="relative z-10 flex flex-col items-center justify-center pt-4 px-4 sm:px-6 md:px-10 xl:px-20 2xl:px-32">
        <div className="w-full max-w-screen-xl">
          ...
          <section className="text-center mb-8">
            <img
              src={JumpstartLogo}
              alt="Jumpstart Logo"
              className="w-20 h-20 mb-4 mx-auto animate-bounce"
            />
            <h1 className="text-3xl md:text-4xl font-extrabold text-[#fea434] mb-2 leading-tight">
          ...
          <section className="text-center mb-16">
            <h2 className="text-2xl md:text-3xl font-bold text-[#fea434] mb-4">About Jumpstart</h2>
          ...
          {/* 🔶 Focus Areas */}
          <section className="mb-16">
            <h2 className="text-2xl md:text-3xl font-bold text-[#fea434] text-center mb-10">
              Our Focus Areas
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              {["Skills Development", "Entrepreneurship Training", "ICT Education", "Innovation"].map((title, idx) => (
                ...
                >
                  <h3 className="text-lg font-semibold text-[#fea434] mb-2">{title}</h3>
          ...
          {/* 🟦 Success Stories */}
          <section className="text-center mb-16">
            <h2 className="text-2xl md:text-3xl font-bold text-[#fea434] mb-6">Success Stories</h2>
            <p className="text-gray-700 text-base mb-6">See how Jumpstart has impacted lives:</p>
          ...
          {/* 🟧 Newsletter Signup */}
          <section className="text-center mb-16">
            <h2 className="text-2xl md:text-3xl font-bold text-[#fea434] mb-4">Stay Connected</h2>
            <p className="text-gray-700 text-base mb-6">Sign up for our newsletter to get the latest updates.</p>
