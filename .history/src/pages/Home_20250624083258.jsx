...
>
  <div className="bg-white/80 backdrop-blur-lg rounded-2xl px-8 py-12 text-center max-w-2xl w-full shadow-lg">
    ...
    <div className="flex justify-center gap-4 mt-4">
     ...
     {/* ✅ About + Focus Areas Unified Section with Blurred Card */}
<section
...
>
  <div className="bg-white/80 backdrop-blur-lg rounded-2xl px-8 py-12 shadow-lg max-w-screen-lg mx-auto">
    {/* About */}
