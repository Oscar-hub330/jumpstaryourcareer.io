  ...
  return (
    <div className="relative text-black flex flex-col min-h-screen w-full overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col gap-16 py-12 px-4 sm:px-6 md:px-10 xl:px-20 2xl:px-32">
        ...
        <section className="w-full max-w-screen-md mx-auto bg-white/90 backdrop-blur-md rounded-3xl shadow-xl px-6 md:px-10 py-12">
          <h2 className="text-3xl md:text-4xl font-bold text-[#fea434] text-center mb-8">Success Stories</h2>
          <div className="space-y-6">
            {["Jumpstart changed my life by teaching me digital skills!", "I started my own business after completing their training.", "Thanks to Jumpstart, I now work in tech and support my family."].map((quote, idx) => (
              <blockquote key={idx} className="bg-white border-l-4 border-[#fea434] pl-4 italic text-gray-600">
                “{quote}”
              </blockquote>
            ))}
          </div>
        ...
        {/* ✅ Newsletter Signup */}
        <section className="w-full max-w-screen-sm mx-auto bg-white/90 backdrop-blur-md rounded-3xl shadow-xl px-6 md:px-10 py-12 text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[#fea434] mb-4">Stay Updated</h2>
          <p className="text-gray-700 text-base mb-6">
            Subscribe to our newsletter for updates on projects, events, and success stories.
          </p>
          <form className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              type="submit"
              variant="contained"
              sx={{ backgroundColor: "#fea434", color: "white", px: 4, '&:hover': { backgroundColor: "#e69420" } }}
            >
              Subscribe
            </Button>
          </form>
