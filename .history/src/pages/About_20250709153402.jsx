...
const About = () => {
  const futuristicBg =
    "radial-gradient(circle at top left, #fdfdfd, #e9f1ff, #d4e4ff)";

  return (
    <div className="text-orange-400 min-h-screen" style={{ background: futuristicBg, backgroundAttachment: "fixed" }}>
      {/* Hero Section */}
      <section className="py-4 rounded-lg mx-4 mt-6">
      ...
      <section className="py-0 rounded-lg mx-4 mt-8">
      ...
      {/* Sponsors Section */}
      <section className="py-0 rounded-lg mx-4 mt-6 mb-8">
        <Container maxWidth="lg">
          <Typography
            variant="h4"
            color="#fea434"
          ...
          <Card
            sx={{
              ...
              borderRadius: 2,
              boxShadow: 2,
              background: `linear-gradient(to bottom right, rgba(255,255,255,0.95), rgba(228,236,255,0.9)), ${futuristicBg}`,
              p: 3,
            }}
          >
      ...
      {/* Call to Action */}
      <section className="py-2 text-center bg-white/70 backdrop-blur-sm rounded-lg mx-4 mt-10">
        <Container maxWidth="md">
          <Typography
            variant="h5"
