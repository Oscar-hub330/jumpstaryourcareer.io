  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        ...
        {/* Horizontal Row of Small Departments */}
        <Grid container spacing={4} mb={6}>
          {[departments[0], departments[1], departments[2], departments[3]].map((dept, deptIdx) => (
        ...
        {/* Remaining Departments (e.g., ICT Team) */}
        {departments.slice(4).map((dept, idx) => (
          <Box key={idx} mb={6}>
            <Typography variant="h5" fontWeight={600} mb={3} color="#fea434">
              {dept.title}
            </Typography>
