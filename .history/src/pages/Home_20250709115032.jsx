...
const Home = () => {
  ...
  const focusAreas = [
    ...
    },
    {
      ...
      description: "Providing digital literacy, AI, and robotics courses to bridge the digital divide — fostering a new generation of tech-savvy individuals and driving creative solutions through emerging technologies.",
    },
    {
      title: "Innovation",
