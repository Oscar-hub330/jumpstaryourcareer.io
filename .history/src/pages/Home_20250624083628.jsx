...
const Home = () => {
  ...
  return (
    ...
    >
      {/* ✅ Hero Section with Blurred Card */}
      <section
        className="min-h-screen flex items-center justify-center px-4"
      >
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl px-8 py-14 text-center max-w-2xl w-full">
          <img
            src={JumpstartLogo}
            alt="Jumpstart Logo"
      ...
      >
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl px-8 py-14 max-w-screen-xl mx-auto">
          {/* About Section */}
