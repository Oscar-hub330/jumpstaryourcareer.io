...
const Home = () => {
  ...
  return (
    <div className="relative text-black flex flex-col min-h-screen w-full overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col gap-16 py-12 px-4 sm:px-6 md:px-10">
        {/* 🔶 Hero Section */}
        <section className="flex flex-col items-center justify-center text-center max-w-3xl mx-auto bg-white/90 backdrop-blur-md p-10 rounded-3xl shadow-xl">
          <img
            src={JumpstartLogo}
            alt="Jumpstart Logo"
            className="w-24 h-24 mb-6 animate-bounce"
          />
          <h1 className="text-4xl font-extrabold text-[#fea434] mb-4 leading-tight">
        ...
        {/* 🔷 About Section */}
        <section className="max-w-4xl mx-auto bg-white/90 backdrop-blur-md rounded-3xl shadow-xl px-8 py-12 text-center">
        ...
        {/* 🔶 Focus Area Section */}
        <section className="max-w-screen-xl mx-auto bg-white/90 backdrop-blur-md rounded-3xl shadow-xl px-6 py-12">
