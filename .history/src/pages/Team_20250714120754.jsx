  ...
  return (
    ...
    >
      <Container maxWidth="lg">
        ...
        {/* Aligned Department Cards (horizontal row) */}
        <Box mb={6}>
          ...
          <Grid container spacing={4} alignItems="stretch" justifyContent="center">
            {departments
              .filter((dept) =>
                ["Communication", "HR", "Finance", "Marketing"].includes(dept.title)
              )
              .map((dept, deptIdx) => (
                <Grid item xs={12} sm={6} md={3} key={deptIdx} sx={{ display: "flex", flexDirection: "column" }}>
                  <Typography
                    variant="h6"
                    fontWeight={600}
                    color="#fea434"
