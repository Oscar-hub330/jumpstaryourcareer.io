...
>
  <div className="bg-white/85 backdrop-blur-md rounded-xl px-6 py-10">
    <Container maxWidth="md" className="text-center mb-10">
    ...
    <Container maxWidth="lg" className="text-center">
      <h2 className="text-3xl font-bold text-[#fea434] mb-8">
        Our Focus Areas
      </h2>
