...
const Home = () => {
  ...
  return (
    <div className="relative text-black flex flex-col min-h-screen w-full overflow-hidden max-w-[1440px] mx-auto">
      {/* 🔲 Hero Background */}
      ...
      <div className="absolute top-4 left-4 z-20 block md:hidden">
        <IconButton
          ...
          sx={{ backgroundColor: "#fea434", color: "white" }}
        >
          <MenuIcon />
        </IconButton>
      </div>
      ...
      <main className="relative z-10 flex flex-col gap-16 py-12 px-4 sm:px-6 md:px-10 xl:px-20 2xl:px-32">
        ...
        <section className="w-full max-w-screen-xl mx-auto bg-white/90 backdrop-blur-md rounded-3xl shadow-xl px-4 sm:px-6 md:px-10 py-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {["Skills Development", "Entrepreneurship Training", "ICT Education", "Innovation"].map(
              (title, idx) => (
                <div
                  key={idx}
