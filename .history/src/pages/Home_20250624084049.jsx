...
const Home = () => {
  ...
  return (
    <div className="text-black">
      ...
      {/* ✅ About + Focus Areas Section with Blurred Background */}
      <section
      ...
      >
        {/* Blur overlay */}
        <div className="absolute inset-0 bg-white/70 backdrop-blur-lg z-0 rounded-3xl"></div>

        {/* Content */}
        <div className="relative z-10 max-w-screen-xl mx-auto rounded-3xl shadow-xl px-8 py-14">
          {/* About Section */}
