...
const Home = () => {
  ...
  return (
    <div className="text-black">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 bg-white/30 overflow-hidden">
        ...
        {/* Foreground card */}
        <div className="relative z-10 bg-white/80 backdrop-blur-lg rounded-2xl px-8 py-12 text-center max-w-2xl w-full shadow-lg">
          <img
            src={JumpstartLogo}
            alt="Jumpstart Logo"
      ...
      {/* ✅ About + Focus Areas Section — uses same blurred SVG background */}
      <section className="relative bg-white/30 py-20 px-4 overflow-hidden">
        {/* Reusing same background SVG with blur */}
        <div
          className="absolute inset-0 bg-cover bg-center bg-no-repeat filter blur-sm scale-105"
          style={{
            backgroundImage: `url('/src/assets/car.svg')`,
        ...
        {/* Content container */}
        <div className="relative z-10 max-w-screen-xl mx-auto bg-white/80 backdrop-blur-lg rounded-3xl shadow-xl px-8 py-14">
          {/* About Section */}
          <Container maxWidth="md" className="text-center mb-16">
